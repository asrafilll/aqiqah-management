...
@endphp
<div class="col-6" id="meat_menu_option">
    <label for="">Olahan Daging</label>
    <select name="package[{{ $index }}][meat_menu]" class="form-control"
        value="{{ $meatId }}" onchange="freeTextChange(this.value, 'meat')">
...
<div class="col-6" id="offal_menu_option">
    <label for="">Olahan Jeroan</label>
    <select name="package[{{ $index }}][offal_menu]" class="form-control"
        value="{{ $offalId }}" onchange="freeTextChange(this.value, 'offal')">
