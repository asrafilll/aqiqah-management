...
<div class="col-6 {{ $meatId == 'free_text' ? '' : 'd-none' }}" id="meat_menu_input">
...
<div class="col-6">
    ...
    <select name="package[{{ $index }}][offal_menu]" class="form-control"
        id="" value="{{ $offalId }}" onchange="freeTextChange(this.value, 'offal')">
        ...
        @endforeach
        <option value="free_text" {{ $offalId == 'free_text' ? 'selected' : '' }}>Free text</option>
    </select>
</div>
<div class="col-6 {{ $offalId == 'free_text' ? '' : 'd-none' }}" id="offal_menu_input">
    <label for="">Custom Jeroan</label>
    <input type="text" class="form-control" id="offal_menu_input_text" name="package[{{ $index }}][offal_menu_custom]"
        value="{{ $offalName }}">
</div>
...
<div class="col-4">
    ...
    <select name="package[{{ $index }}][egg_menu]" class="form-control"
        id="" value="{{ $eggId }}" onchange="freeTextChange(this.value, 'egg')">
        ...
        @endforeach
        <option value="free_text" {{ $eggId == 'free_text' ? 'selected' : '' }}>Free text</option>
    </select>
</div>
<div class="col-4 {{ $eggId == 'free_text' ? '' : 'd-none' }}" id="egg_menu_input">
    <label for="">Custom Telur</label>
    <input type="text" class="form-control" id="egg_menu_input_text" name="package[{{ $index }}][egg_menu_custom]"
        value="{{ $eggName }}">
</div>
